...
public class Cliente implements Comparable<Cliente> {
	...
	public Cliente(String nombres, String apellidos, String documento, Banco banco, int edad) {
		super();
	...
	public String toString() {
		return "Cliente [nombres=" + nombres + ", apellidos=" + apellidos + ", documento=" + documento
				+ ", listaCuentas=" + listaCuentas + ", banco=" + banco + "]";
	}
